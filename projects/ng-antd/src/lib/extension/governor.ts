import { Directive, ElementRef, Injectable, Injector, KeyValueDiffer, KeyValueDiffers, Renderer2, Type } from '@angular/core'
...
export class GovernorFactory {
  create(injector: Injector): Governor {
    return new Governor(
      ...
      injector.get(Renderer2 as Type<Renderer2>),
      injector.get(KeyValueDiffers as Type<KeyValueDiffers>),
    )
  }
}
